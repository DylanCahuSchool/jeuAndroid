...
public class Player1Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_player1, container, false);
        ...
        button.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if (!name.isEmpty()) {
                    ...
                    player.Name = name;
                    player.Level = level;
                    ((MainActivity)getActivity()).player1 = player;
        
                    // Remplacer Player1Fragment par Player2Fragment
                    getActivity().getSupportFragmentManager().beginTransaction()
                        .replace(R.id.nav_host_fragment_content_main, new Player2Fragment())
                        .commit();
                }
            }
        });
